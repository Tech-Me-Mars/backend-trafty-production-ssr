      ...
      <nav class="navbar navbar-expand">
        <div class="collapse navbar-collapse justify-content-between">
          ...
          <ul class="navbar-nav header-right">
                ...
                <div id="DZ_W_TimeLine02" class="widget-timeline dz-scroll style-1 p-3 height370">
                  <ul class="timeline">
                    <li>
                      ...
                      <NuxtLink class="timeline-panel text-muted" to="?">
                        <span>10 minutes ago</span>
                        <h6 class="mb-0">
                          Youtube, NuxtLink video-sharing website, goes live
                    ...
                    <li>
                      ...
                      <NuxtLink class="timeline-panel text-muted" to="?">
                        ...
                        <p class="mb-0">Quisque NuxtLink consequat ante Sit amet magna at volutapt...</p>
                      </NuxtLink>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <NuxtLink class="timeline-panel text-muted" to="?">
                        <span>20 minutes ago</span>
                        <h6 class="mb-0">Mashable, NuxtLink news website and blog, goes live.</h6>
                      </NuxtLink>
                    </li>
                    <li>
            ...
            <li class="nav-item dropdown notification_dropdown">
              <a class="nav-link" href="?" role="button" data-bs-toggle="dropdown" v-html="headerNotifiationSvg"> </a>
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <NuxtLink class="all-notification" to="?">See all notifications <i class="ti-arrow-end"></i></NuxtLink>
              </div>
            </li>
            <li class="nav-item dropdown notification_dropdown">
              <a class="nav-link bell-link" href="javascript:void(0)" v-html="headerChatSvg" @click="chatboxHandler"> </a>
            </li>
            <li class="nav-item dropdown notification_dropdown">
              <a :class="`nav-link bell dz-fullscreen ${size ? 'active' : ''}`" href="javascript:void(0)" v-html="headerZoomSvg" @click="fullScreen"> </a>
            </li>
            <li class="nav-item ps-3">
              <div class="dropdown header-profile2">
                <NuxtLink class="nav-link" to="?" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="dropdown-menu dropdown-menu-end" style="">
                  <div class="card border-0 mb-0">
                    ...
                    <div class="card-body px-0 py-2">
                      <NuxtLink to="/app-profile" class="dropdown-item ai-icon">
                      ...
                      <NuxtLink to="?" class="dropdown-item ai-icon">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                      ...
                      <NuxtLink to="/email-inbox" class="dropdown-item ai-icon">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                    ...
                    <div class="card-footer px-0 py-2">
                      ...
                      <NuxtLink to="/page-login" class="dropdown-item ai-icon">
                        <svg
                          class="profle-logout"
                          xmlns="http://www.w3.org/2000/svg"
                          width="18"
