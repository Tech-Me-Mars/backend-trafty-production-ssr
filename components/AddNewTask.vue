...
<template>
        ...
        <form>
          <div class="row">
            ...
            <div class="col-xl-6 mb-3">
              ...
              >
              <div
                class="dropdown bootstrap-select default-select style-1 form-control"
              >
                <CustomSelect
                  :options="[
                    { title: 'Salesmate' },
            ...
            <div class="col-xl-6 mb-3">
              <label class="form-label"
                >Estimated Hour<span class="text-danger">*</span></label
              >
            ...
            <div class="col-xl-6 mb-3">
              <label class="form-label"
                >Deadline add<span class="text-danger">*</span></label
              >
            ...
            <div class="col-xl-6 mb-3">
              <label class="form-label"
                >Responsible Person<span class="text-danger">*</span></label
              >
  ...
  >
    ...
    <div class="offcanvas-body">
      <div class="container-fluid">
        <div class="col-xl-12 mb-3">
          <label for="exampleFormControlInput1" class="form-label font-w500"
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-primary">
                    <input
                      type="checkbox"
                      class="form-check-input"
                      id="customCheckBox131"
                      required
                    />
                    <label class="form-check-label" for="customCheckBox131"
                      >Add</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-warning">
                    <input
                      ...
                      class="form-check-input"
                      checked
                      id="customCheckBox132"
                      required
                    />
                    <label class="form-check-label" for="customCheckBox132"
                      >Edit</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-warning">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox15"
                      >Edit</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox16"
                      >Delete</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-primary">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox17"
                      >Add</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-warning">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox18"
                      >Edit</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox19"
                      >Delete</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-primary">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox20"
                      >Add</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox22"
                      >Delete</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox25"
                      >Delete</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-primary">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox26"
                      >Add</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-warning">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox27"
                      >Edit</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox28"
                      >Delete</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-primary">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox29"
                      >Add</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-warning">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox30"
                      >Edit</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox31"
                      >Delete</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-primary">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox32"
                      >Add</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-warning">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox33"
                      >Edit</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox34"
                      >Delete</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-primary">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox35"
                      >Add</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-warning">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox36"
                      >Edit</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox37"
                      >Delete</label
                    >
                  </div>
                </td>
                ...
                <td>
                  <div class="form-check custom-checkbox checkbox-primary">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox38"
                      >Add</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-warning">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox39"
                      >Edit</label
                    >
                  </div>
                </td>
                <td>
                  <div class="form-check custom-checkbox checkbox-danger">
                    <input
                      ...
                      required
                    />
                    <label class="form-check-label" for="customCheckBox40"
                      >Delete</label
                    >
                  </div>
                </td>
        ...
        <div>
          <a href="javascript:void(0)" class="btn btn-light btn-sm me-1"
            >Discard</a
          >
