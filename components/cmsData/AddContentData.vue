...
import AddContentSelect from "../AddContentSelect.vue";
  ...
  <div class="row">
    <div class="col-xl-8">
      ...
      <div class="filter cm-content-box box-primary">
        <div class="content-title SlideToolHeader collapse" data-bs-toggle="collapse" data-bs-target="#SlideToolHeader" aria-controls="SlideToolHeader" aria-expanded="true">
        ...
        <div class="cm-content-body form excerpt collapse show" id="Author">
          <div class="card-body">
            ...
            <v-select
              ...
              :options="[{ title: 'admin@gmail.com' }, { title: 'India' }, { title: 'Information' }, { title: 'New Menu' }, { title: 'Page Menu' }]"
              label="title"
            />
          </div>
        </div>
    ...
    <div class="col-xl-4">
      <div class="right-sidebar-sticky">
          ...
          <div class="cm-content-body publish-content form excerpt collapse show" id="Published">
            <div class="card-body pb-0">
              ...
              <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-bs-parent="#accordion-one">
                <div class="accordion-body-text border rounded">
                  <div class="mb-2">
                    ...
                    <div class="dropdown bootstrap-select publish-drop default-select">
                      <CustomSelect :options="[{ title: 'Select Status' }, { title: 'Published' }, { title: 'Draft' }, { title: 'Trash' }, { title: 'Private' }, { title: 'Pending' }]" />
                    </div>
                  </div>
                  <div>
              ...
              <ul class="d-flex align-items-center mb-2 flex-wrap">
                ...
                <li>
                  <strong><a href="javascript:void(0);" class="mx-2">on :24-09-2023 16:22:52 </a></strong>
                </li>
                <li>
                  <a
                    href="javascript:void(0);"
        ...
        <div class="filter cm-content-box box-primary">
          ...
          <div class="cm-content-body publish-content form excerpt collapse show" id="CollapsePage">
            <div class="card-body">
              ...
              <AddContentSelect
                valueOne="(No Parent)"
                valueTwo="Privacy Policy"
                valueThree="Contact Us"
                valueFour="Important Information"
                valueFive="Free shipping"
                valueSix="Daily Gifts"
                valueSaven="Blog"
                valueEght="About Us"
                valueNine="Dummy Co"
              />
        ...
        <div class="filter cm-content-box box-primary">
          <div class="content-title SlideToolHeader collapse" data-bs-toggle="collapse" data-bs-target="#CollapsePageType" aria-controls="CollapsePageType" aria-expanded="true">
            <div class="cpa">Page Type</div>
            <div class="tools">
              <a href="javascript:void(0);" class="expand handle"><i class="fal fa-angle-down"></i></a>
            </div>
          </div>
          <div class="cm-content-body publish-content form excerpt collapse show" id="CollapsePageType">
            <div class="card-body">
              <label class="form-label">Content Type</label>
              <CustomSelectOption valueOne="Page" valueTwo="Widget" />
            </div>
          </div>
        </div>
        <div class="filter cm-content-box box-primary">
          <div class="content-title SlideToolHeader collapse" data-bs-toggle="collapse" data-bs-target="#CollapsePageType2" aria-controls="CollapsePageType2" aria-expanded="true">
