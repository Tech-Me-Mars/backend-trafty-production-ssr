<template>
    ...
    <div class="card bg-success overflow-hidden">
      ...
      <div class="chart-wrapper">
        <div id="chart_widget_5">
          <apexchart type="area" height="150" :options="chart_widget_5.chartOptions" :series="chart_widget_5.series"></apexchart>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-auto">
            <div class="chart-wrapper height100">
              <Bar id="chart_widget_7" :data="chart_widget_7.data" :options="chart_widget_7.options" />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
        ...
        <div class="card">
          ...
          <div class="chart-wrapper">
            <div id="chart_widget_6">
              <apexchart type="area" height="150" :options="chart_widget_6.chartOptions" :series="chart_widget_6.series"></apexchart>
            </div>
          </div>
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="chart-wrapper">
            <Bar id="chart_widget_3" :data="chart_widget_3.data" :options="chart_widget_3.options" />
          </div>
          <div class="card-footer">
            <div class="row">
              <div class="col text-center">
    ...
    <div class="card">
      ...
      <div class="chart-wrapper">
        <div id="chart_widget_8">
          <apexchart type="line" height="219" :options="chart_widget_8.chartOptions" :series="chart_widget_8.series"></apexchart>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-xl-6 col-lg-12">
    <div class="card overflow-hidden">
      ...
      <div class="chart-wrapper">
        <Line :data="chart_widget_10.data" :options="chart_widget_10.options" id="chart_widget_10" />
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card overflow-hidden">
          <div class="row no-gutters">
            ...
            <div class="col-7 p-0">
              <div class="chart-wrapper">
                <Line :data="chart_widget_11.data" :options="chart_widget_11.options" id="chart_widget_11" />
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-sm-6">
        <div class="card">
          ...
          <div class="chart-wrapper">
            <Line :data="chart_widget_14.data" :options="chart_widget_14.options" id="chart_widget_14" />
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="card">
          ...
          <div class="chart-wrapper">
            <Line :data="chart_widget_15.data" :options="chart_widget_15.options" id="chart_widget_15" />
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-xl-6 col-xxl-4 col-lg-12">
    <div class="card">
      <div class="chart-wrapper">
        <Line height="269" :data="chart_widget_16.data" :options="chart_widget_16.options" id="chart_widget_16" />
      </div>
      <div class="card-body">
