    ...
    <div class="card-body d-flex">
      ...
      <div class="clearfix d-xl-flex flex-grow-1">
        ...
        <div class="clearfix mt-3 mt-xl-0 ms-auto d-flex flex-column col-xl-3">
          ...
          <div class="mt-auto d-flex align-items-center" style="position: relative">
            ...
            <div id="chartProfileProgress" style="min-height: 100px">
              <ClientOnly>
                <VueApexCharts height="100" :series="state.series" :options="state.options" />
              </ClientOnly>
            </div>

            <div class="resize-triggers">
              <div class="expand-trigger"><div style="width: 359px; height: 101px"></div></div>
    ...
    <div class="card-footer py-0 d-flex flex-wrap justify-content-between align-items-center px-0">
      <ul class="nav nav-underline nav-underline-primary nav-underline-text-dark nav-underline-gap-x-0" id="tabMyProfileBottom" role="tablist">
        <li class="nav-item ms-1" role="presentation">
          <NuxtLink to="/profile/overview" :class="`nav-link py-3 border-3 text-dark ${'Overview' == title ? 'active' : ''}`">Overview</NuxtLink>
        </li>
        <li class="nav-item ms-1" role="presentation">
          <NuxtLink to="/profile/projects" :class="`nav-link py-3 border-3 text-dark ${'Projects' == title ? 'active' : ''}`">Projects</NuxtLink>
        </li>
        <li class="nav-item ms-1" role="presentation">
          <NuxtLink to="/profile/campaigns" :class="`nav-link py-3 border-3 text-dark ${'Campaigns' == title ? 'active' : ''}`">Campaigns</NuxtLink>
        </li>
        <li class="nav-item ms-1" role="presentation">
          <NuxtLink to="/profile/documents" :class="`nav-link py-3 border-3 text-dark ${'Documents' == title ? 'active' : ''}`">Documents</NuxtLink>
        </li>
        <li class="nav-item ms-1" role="presentation">
          <NuxtLink to="/profile/followers" :class="`nav-link py-3 border-3 text-dark ${'Followers' == title ? 'active' : ''}`">Followers</NuxtLink>
        </li>
        <li class="nav-item ms-1" role="presentation">
          <NuxtLink to="/profile/activity" :class="`nav-link py-3 border-3 text-dark ${'Activity' == title ? 'active' : ''}`">Activity</NuxtLink>
        </li>
      </ul>
