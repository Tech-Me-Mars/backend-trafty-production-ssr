      ...
      <div class="col-xl-12">
        <div class="filter cm-content-box box-primary">
          <div class="content-title">
            ...
            <div class="tools">
              <a data-bs-toggle="collapse" href="#menuCollapese" role="button" aria-expanded="false" aria-controls="menuCollapese"
            ...
            <div class="card-body">
              <div class="row align-items-center p-3">
                ...
                <div class="col-xl-6 col-xxl-5 mb-xl-0 mb-3">
                  <div class="dropdown bootstrap-select form-control default-select dashboard-select-2 h-auto wide">
                    <CustomSelect
                      :options="[
                        { title: 'Select Menu' },
                        { title: 'India' },
                      ...
                      <div class="card-body ItemsCheckboxSec">
                        ...
                        <div class="tab-content" id="myTabContent">
                          ...
                          <div class="d-flex align-items-center flex-wrap">
                            <a href="javascript:void(0);" class="checkAllInput" @click="checkAllInput = true">Select All</a
...
export default defineComponent({
  ...
  components: { CustomSelect, CommonNavbar, draggable: VueDraggableNext },
});
</script>
