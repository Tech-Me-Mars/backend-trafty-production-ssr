<template>
  <CommonNavbar page="AIKit" path="Repurpose" />
    ...
    <div class="row">
      <div class="col-xl-12">
        ...
        <p>
          ...
          review and edit before publishing for best results. This is not a
        ...
        <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <RouterLink to="/repurpose" class="nav-link active"
              >Repurpose</RouterLink
            >
          </li>
          <li class="nav-item" role="presentation">
            ...
            <ul class="nav nav-tabs align-items-end" id="myTab" role="tablist">
              ...
              <li class="nav-item" role="presentation">
                <button
                  ...
                  aria-selected="false"
                >
                  Jobs<span class="badge badge-circle badge-light light ms-2"
                    >5</span
                  >
                </button>
              </li>
                      ...
                      <div class="col-xl-12">
                        <div class="mb-3">
                          <label
                            ...
                            class="form-label"
                            >URL of article, post or video</label
                          >
                          <input
                            type="text"
                            class="form-control"
                        ...
                        <div class="mb-3">
                          <CustomSelectOption
                            valueOne="Draft"
                            valueTwo="Uncategorized"
                          />
                        </div>
                        <hr style="margin-left: -21px; margin-right: -21px" />
                        <div
                          class="btn-group ai-tag-group"
                          role="group"
                      ...
                      <tr>
                        <td>
                          <a href="javascript:void(0);"
                            >www.wsj.com/articles/harvard-discriminates-against-middle-class-kids-legacy-admissions-court-85cf4503</a
                          >
                        </td>
                        <td>URL</td>
