...
<template>
  <CommonNavbar page="AIKit" path="Settings" />
  <ClientOnly>
      ...
      <div class="row">
        <div class="col-xl-12">
          ...
          <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
              <NuxtLink to="/prompt" class="nav-link">AI Menu Prompts</NuxtLink>
            </li>
            <li class="nav-item" role="presentation">
              <NuxtLink to="/setting" class="nav-link active">Settings</NuxtLink>
            </li>
            <li class="nav-item" role="presentation">
            ...
            <div class="card-body border-0 pb-0">
              ...
              <div class="row">
                <div class="col-xl-6 col-sm-6">
                  <div class="mb-3">
                    ...
                    <div id="emailHelp" class="form-text">
                      For instructions on how to get an OpenAI key, please visit<a href="javascript:void(0);" class="text-primary"> https://getaikit.com/docs/getting-started</a>
                    </div>
                  </div>
                </div>
                <div class="col-xl-6 col-sm-6">
                  <div class="mb-3">
                    ...
                    <div id="emailHelp-1" class="form-text">
                      Enter your RapidAPI key for Subtitles for YouTube here. This API is used to read YouTube video subtitles to allow you to fetch.
                      <a href="javascript:void(0);" class="text-primary"
                        >Read More<svg class="ms-1" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-xl-3 col-sm-6">
                  ...
                  <div class="mb-3">
                    <CuntrySelectOption />
                    <div id="emailHelp-2" class="form-text">
                ...
                <div class="col-xl-3 col-sm-6">
                  ...
                  <div class="mb-3">
                    <CustomSelectOption value-one="gpt-3.5-turbo" value-two="gpt-4.5-turbo" />
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="mb-3">
                    ...
                    <div id="emailHelp-5" class="form-text">
                      The language of the text you want to generate.
                      <a href="javascript:void(0);" class="text-primary"
                        >Read More<svg
                          class="ms-1"
                ...
                <div class="col-xl-3 col-sm-6">
                  ...
                  <div id="emailHelp-6" class="form-text mb-2">
                ...
                <div class="col-xl-3 col-sm-6">
                  ...
                  <div id="emailHelp-7" class="form-text mb-2">
                    The language of the text you want to generate.
                    <a href="javascript:void(0);" class="text-primary"
                      >Read More<svg
                        class="ms-1"
                ...
                <div class="col-xl-3 col-sm-6">
                  ...
                  <div id="emailHelp-8" class="form-text mb-2">
                ...
                <div class="col-xl-3 col-sm-6 align-self-end">
                  ...
                  <div id="emailHelp-9" class="form-text mb-2">
                    When this is enabled, you will be able to use AIKit right.
                    <a href="javascript:void(0);" class="text-primary"
                      >Read More<svg
                        class="ms-1"
                ...
                <div class="col-xl-3 col-sm-6 align-self-end">
                  ...
                  <div id="emailHelp-10" class="form-text mb-2">
                    When this is enabled, you will be able to use AIKit right.
                    <a href="javascript:void(0);" class="text-primary"
                      >Read More<svg
                        class="ms-1"
                ...
                <div class="col-xl-6">
                  <div class="mb-3">
                    ...
                    <Vselect
                      ...
                      multiple
                      :options="['Watercolor', 'Vector Art', 'Portrait', 'Pencil Drawing', 'Digital Painting', 'Abstract', 'Oil Painting', 'Cartoon', 'Black And White']"
                    ></Vselect>
                    <div id="emailHelp-11" class="form-text mb-2">
                      System message help set the behaviour of the model. You can use it to ask the model to mimic a certain style or take a certain perspective for all text
                      generations. For example, if you set this to "Shakespeare' style", the mode will follow the style of Shakespeare in all text generations when possible. System
                      message should work ONLY with GPT-4 and to a lesser extent with gpt-3.5-turbo models.
                    </div>
                  </div>
                </div>
                <div class="col-xl-6">
                  ...
                  <div class="form-floating">
                    ...
                    <div id="emailHelp-12" class="form-text mb-2">
                      System message help set the behaviour of the model. You can use it to ask the model to mimic a certain style or take a certain perspective for all text
                      generations. For example, if you set this to "Shakespeare' style", the mode will follow the style of Shakespeare in all text generations when possible. System
                      message should work ONLY with GPT-4 and to a lesser extent with gpt-3.5-turbo models.
                    </div>
