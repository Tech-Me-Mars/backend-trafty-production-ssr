<template>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-xl-12">
        <div
          class="alert alert-dismissible ai-header-alert fade show mb-5"
          role="alert"
        >
        ...
        <ul class="nav nav-tabs style-1 mb-4" id="pills-tab" role="tablist">
          ...
          <li class="nav-item" role="presentation">
            <RouterLink to="/fine-tune-models" class="nav-link active"
              ...
              <div class="card-body p-0">
                <div class="table-responsive active-projects style-1">
                  <table id="empoloyees-tblwrapper" class="table mb-0">
                    ...
                    <tbody>
                      <tr
                        v-for="({ status, badge }, ind) in paginatedData"
                        :key="ind"
                      >
