          ...
          <div class="card-body py-0 pe-0">
            <div class="row gx-0">
              <div class="col-xl-2 col-xxl-3 col-lg-3">
                <div
                  :class="`email-left-body ${
                    emaiComposeMenuToggle ? 'active' : ''
                  }`"
                >
                  <EmailRightContent />
                </div>
                ...
                <div class="email-right-box">
                    ...
                    <div class="saprat">
                      <div class="d-flex align-items-center">
                        <div class="btn-group">
                          <div class="form-check custom-checkbox">
                            <input
                              ...
                              id="checkAll"
                              @click="allCheckInputs = !allCheckInputs"
                            />
                            <label
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                          <li
                            class="nav-item btn-group ms-0"
                            role="presentation"
                          >
                            <button
                              class="btn effect mx-2 nav-link active"
                              id="pills-home-tab"
                              data-bs-toggle="pill"
                          ...
                          <li class="nav-item btn-group" role="presentation">
                            <button
                              class="btn mx-2 effect nav-link"
                          ...
                          <li class="nav-item btn-group" role="presentation">
                            <button
                              class="btn mx-sm-2 mx-0 effect nav-link"
                      ...
                      <div class="mail-tools">
                        ...
                        <div
                          :class="`email-tools-box ${
                            emaiComposeMenuToggle ? 'active' : ''
                          }`"
                          @click="
                            emaiComposeMenuToggle = !emaiComposeMenuToggle
                          "
                        >
                  ...
                  <div class="tab-content" id="pills-tabContent">
                    ...
                    >
                      <div class="email-list dz-scroll" id="emails">
                        <div
                          class="message"
                          v-for="({ title }, ind) in emailInboxData"
                          :key="ind"
                        >
                          <div>
                            ...
                            >
                              <div class="hader">{{ title }}</div>
                              <div class="subject">
                                working time in this pandemic<span>
                  ...
                  <div class="row gx-0">
                    <div class="col-12 ps-3">
                      <div
                        class="pagination pagination-xs d-flex justify-content-between align-items-center"
                      >
                        <p class="mb-0">
