          ...
          <div class="card-body py-0 pe-0">
            <div class="row gx-0">
              <div class="col-xl-2 col-xxl-3 col-lg-3">
                <div :class="`email-left-body ${emaiComposeMenuToggle ? 'active' : ''}`">
                  <EmailRightContent />
                </div>
              </div>
                        ...
                        <div class="read-wapper dz-scroll" id="read-content">
                          <div class="read-content">
                            ...
                            <div class="read-content-body">
                              ...
                              <p class="mb-2">
                                <strong>Ingredia Nutrisha,</strong> A collection of textile samples lay spread out on the table - Samsa was a
                              ...
                              <p class="mb-2">
                                ...
                                however a small line of blind text by the name of Lorem Ipsum decided to leave for the far World of Grammar. Aenean
