    ...
    <div class="row">
      <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center">
          ...
          <NuxtLink to="/edit-profile" class="btn btn-primary btn-sm ms-2"
            >+ Add User</NuxtLink
          >
        </div>
      </div>
          ...
          >
            <div class="row">
              <div
                ...
                v-for="(
                  { date, img, name, position, userDisactive }, ind
                ) in userCards"
                :key="ind"
              >
                <div class="card">
                  <div class="card-body">
                    <div class="card-use-box">
                      ...
                      <div>
                        <NuxtLink to="/chat" class="btn btn-primary btn-sm me-2"
                          >Message</NuxtLink
                        >
                        <a
