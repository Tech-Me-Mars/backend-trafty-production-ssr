            ...
            <div class="post-details">
              ...
              <ul class="mb-4 post-meta d-flex flex-wrap">
                ...
                <li class="post-date me-3">
                  <i class="far fa-calendar-plus me-2"></i>18 Nov 2020
                </li>
                <li class="post-comment">
                  <i class="far fa-comment me-2"></i>28
                </li>
              </ul>
              <img
              ...
              <blockquote>
                ...
                industry. Has been the industry's standard text ever since the
              ...
              <div class="profile-skills mt-5 mb-5">
                ...
                <a
                  href="javascript:void();;"
                  class="btn btn-primary light btn-xs mb-1 me-1"
                  >Admin</a
                >
                <a
                  href="javascript:void();;"
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="mb-3">
                        <label
                          for="author"
                          class="text-black font-w600 form-label"
                          >Name <span class="required">*</span></label
                        >
                        <input
                          type="text"
