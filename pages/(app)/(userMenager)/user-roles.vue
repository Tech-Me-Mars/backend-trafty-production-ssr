  ...
  <div class="container-fluid">
    <div class="row">
      <div class="d-flex align-items-center justify-content-between">
        ...
        <a class="btn btn-primary btn-sm mb-3" data-bs-toggle="offcanvas" href="#offcanvasExample" role="button" aria-controls="offcanvasExample"
          >+ Add a role</a
        >
      </div>
            ...
            <div class="card">
              ...
              <div class="card-body px-0 py-2">
                <ul class="personal-info">
                  <li>
                    <a href="javascript:void(0);"><i class="fa-solid fa-user text-primary me-2"></i> Profile</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"><i class="fa-solid fa-lock text-primary me-2"></i> Password</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"><i class="fa-solid fa-calendar-days text-primary me-2"></i> Date</a>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div class="col-xl-12">
            <div class="card">
              ...
              <div class="card-body px-0 py-2">
                <ul class="personal-info">
                  <li>
                    <a href="javascript:void(0);"><i class="fa-solid fa-building text-primary me-2"></i> Commpany Details</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"><i class="fa-solid fa-user-plus text-primary me-2"></i> Team Members</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"><i class="far fa-clock text-primary me-2"></i> Format setting</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"><i class="fa-solid fa-briefcase text-primary me-2"></i> Job boards</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"><i class="far fa-user text-primary me-2"></i> Positions</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"><i class="fas fa-times-circle text-danger me-2"></i>Rejections resions</a>
                  </li>
                  <li>
                    <a href="javascript:void(0);"><i class="fas fa-envelope text-primary me-2"></i>Automated message</a>
                  </li>
                </ul>
              </div>
            </div>
