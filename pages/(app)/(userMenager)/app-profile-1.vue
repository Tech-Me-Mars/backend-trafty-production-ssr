...
export default defineComponent({
  name: "appProfile_1",
  components: { Lightgallery, CommonNavbar },
  data: () => ({
  ...
  setup() {
    return {
      post: [
        { img: IMAGE.profilePic8 },
        { img: IMAGE.profilePic9 },
        { img: IMAGE.profilePic8 },
      ],
      gallery: [
              ...
              <div class="profile-details">
                ...
                <div class="dropdown ms-auto">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li class="dropdown-item">
                      <i class="fa fa-users text-primary me-2"></i> Add to close
                      friends
                    </li>
                    <li class="dropdown-item">
            ...
            <div class="card">
              <div class="card-body">
                <div class="profile-blog">
                  ...
                  />
                  <h4>
                    <NuxtLink to="/post-details" class="text-black"
                      >Darwin Creative Agency Theme</NuxtLink
                    >
                  </h4>
                  <p class="mb-0">
                      ...
                      <div class="profile-news">
                        <div class="media pt-3 pb-3">
                          ...
                          <div class="media-body">
                            <h6 class="m-b-5">
                              <NuxtLink to="/post-details" class="text-black"
                                >Collection of textile samples</NuxtLink
                              >
                            </h6>
                            <p class="mb-0">
                ...
                <div class="tab-content">
                  <div id="my-posts" class="tab-pane fade active show">
                    <div class="my-post-content pt-3">
                        ...
                        <div class="modal fade" id="linkModal">
                          ...
                          >
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <a
                                  class="btn-social facebook me-1"
                                  href="javascript:void(0)"
                                  ><i class="fab fa-facebook-f"></i
                                ></a>
                                <a
                                  class="btn-social google-plus me-1"
                                  href="javascript:void(0)"
                                  ><i class="fab fa-google-plus-g"></i
                                ></a>
                                <a
                                  class="btn-social linkedin me-1"
                                  href="javascript:void(0)"
                                  ><i class="fab fa-linkedin-in"></i
                                ></a>
                                <a
                                  class="btn-social instagram me-1"
                                  href="javascript:void(0)"
                                  ><i class="fab fa-instagram"></i
                                ></a>
                                <a
                                  class="btn-social twitter me-1"
                                  href="javascript:void(0)"
                                  ><i class="fab fa-twitter"></i
                                ></a>
                                <a
                                  class="btn-social youtube me-1"
                                  href="javascript:void(0)"
                      ...
                      >
                        ...
                        />
                        <NuxtLink class="post-title" to="/post-details"
                          ><h3 class="text-black">
                        ...
                        <p>
                          ...
                          soul like these sweet morning of spare which enjoy
                          whole heart.A wonderful serenity has take possession
                          of my entire soul like these sweet morning of spare
                        ...
                        >
                          <span class="me-2"><i class="fa fa-reply"></i></span
                          >Reply
                        </button>
                      </div>
                    </div>
                  ...
                  <div id="about-me" class="tab-pane fade">
                    <div class="profile-about-me">
                      <div class="pt-4 border-bottom-1 pb-3">
                        ...
                        <p class="mb-2">
                          ...
                          charm of existence was created for the bliss of souls
                          like mine.I am so happy, my dear friend, so absorbed
                    ...
                    <div class="profile-skills mb-5">
                      ...
                      <a
                        href="javascript:void(0);"
                        class="btn btn-primary light btn-xs me-2"
                        >Admin</a
                      >
                      <a
                        href="javascript:void(0);"
              ...
              <div class="modal fade" id="replyModal">
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form>
                        <textarea class="form-control h-50" rows="4">
Message</textarea
                        >
                      </form>
                    </div>
