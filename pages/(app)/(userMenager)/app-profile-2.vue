        ...
        <div class="card card-profile">
          <div class="admin-user">
            <div class="img-wrraper">
              ...
              <NuxtLink class="icon-wrapper" to="/edit-profile"
                        ...
                        <div class="about-me">
                          ...
                          <div>
                            <a
                              ...
                              class="btn btn-block bg-facebook mb-2"
                              ><i class="fa-brands fa-facebook-f me-2"></i
                              >Facebook</a
                            >
                            <a
                              href="javascript:void(0)"
                              class="btn btn-block bg-whatsapp mb-2"
                    ...
                    >
                      <div class="accordion-body">
                        <div class="products mb-3">
                          ...
                          <div>
                            <h6>
                              <a href="javascript:void(0)">Liam Antony</a>
                            </h6>
                        ...
                        <div class="products mb-3">
                          ...
                          <div>
                            <h6>
                              <a href="javascript:void(0)">Oliver Elijah</a>
                            </h6>
                        ...
                        <div class="products mb-3">
                          ...
                          <div>
                            <h6>
                              <a href="javascript:void(0)">James William</a>
                            </h6>
                        ...
                        <div class="products">
                          ...
                          <div>
                            <h6>
                              <a href="javascript:void(0)">Benjamin Lucas</a>
                            </h6>
            ...
            <div class="card">
              <div class="card-header border-0">
                ...
                <div class="dropdown custom-dropdown">
                  <div
                    class="btn sharp btn-primary tp-btn ms-3"
              ...
              <div class="card-body pt-0">
                <div class="row">
                  <div class="col-xl-6">
                    <div class="post-img">
                      <img
                        src="../../../assets/images/post/post11.jpg"
                        class="me-3"
                        alt=""
                      />
                    </div>
                  ...
                  <div class="col-xl-6">
                    <div class="post-img">
                      <img
                        src="../../../assets/images/post/post12.jpg"
                        alt=""
                      />
                    </div>
                  </div>
              ...
              <div class="card-body pt-0">
                <div class="row">
                  ...
                  <div class="col-xl-6">
                    <div class="post-img">
                      <img
                        src="../../../assets/images/post/post13.jpg"
                        alt=""
                      />
                    </div>
                  </div>
