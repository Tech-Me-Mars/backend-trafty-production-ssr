                  ...
                  <ul class="nav nav-tabs slide-item-list mt-3" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <a
                        ...
                        aria-selected="true"
                        ><img class="img-fluid me-2 rounded" src="../../../assets/images/tab/1.jpg" alt="" width="80"
                      /></a>
                    </li>
                    <li class="nav-item" role="presentation">
                      <a
                        ...
                        aria-selected="false"
                        ><img class="img-fluid me-2 rounded" src="../../../assets/images/tab/2.jpg" alt="" width="80"
                      /></a>
                    </li>
                    <li class="nav-item" role="presentation">
                      <a
                        ...
                        aria-selected="false"
                        ><img class="img-fluid me-2 rounded" src="../../../assets/images/tab/3.jpg" alt="" width="80"
                      /></a>
                    </li>
                    <li class="nav-item" role="presentation">
                      <a
                        ...
                        aria-selected="false"
                        ><img class="img-fluid rounded" src="../../../assets/images/tab/4.jpg" alt="" width="80"
                      /></a>
                    </li>
                  </ul>
                </div>
              ...
              <div class="col-xl-9 col-lg-6 col-md-6 col-sm-12">
                <div class="product-detail-content">
                  ...
                  <div class="new-arrival-content pr">
                    ...
                    <p>
                      Product tags:&nbsp;&nbsp;
                      <span class="badge badge-success light">bags</span>{{ " " }} <span class="badge badge-success light">clothes</span>{{ " " }}
                      <span class="badge badge-success light">shoes</span>{{ " " }} <span class="badge badge-success light">dresses</span>{{ " " }}
                    </p>
                    ...
                    <div class="d-flex align-items-end flex-wrap mt-4">
                      ...
                      <div class="shopping-cart mb-1 me-3">
                        <a class="btn btn-primary" href="javascript:void(0);;"><i class="fa fa-shopping-basket me-2"></i>Add to cart</a>
                      </div>
                    </div>
                  </div>
                </div>
