<template>
  <div class="page-titles">
    ...
    <a class="text-primary fs-13" data-bs-toggle="offcanvas" href="#addContact" role="button" aria-controls="addContact">+ Add Task</a>
  </div>
    ...
    <div class="row">
      <div class="col-xl-12 active-p">
        <div class="d-flex align-items-center justify-content-between mb-4">
          ...
          <div>
            <a class="btn btn-primary btn-sm me-1" data-bs-toggle="offcanvas" href="#addContact" role="button" aria-controls="addContact"
              >+ Add Contacts</a
            >
            <button type="button" class="btn btn-secondary btn-sm ms-1" data-bs-toggle="modal" data-bs-target="#exampleModal1">
              + Invite Customer
            </button>
          </div>
        </div>
            ...
            <div class="table-responsive active-projects style-1 shorting dt-filter exports">
              <div id="user-tbl_wrapper" class="dataTables_wrapper">
                ...
                <table id="contacts-tbl" class="table">
                  ...
                  <tbody>
                    <tr
                      v-for="({ img, name, email, status, phone, status_color, status_text, date, status2, badge_color }, ind) in paginatedData"
                      :key="ind"
                    >
                      <td>
