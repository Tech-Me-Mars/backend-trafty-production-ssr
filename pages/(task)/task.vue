...
const { data, paginatedData, perPage, nextPage, backPage, goToPage, addActive, sortingArr } = handlePagination(taskTable, 10);

onMounted(() => {
  const ids = [
    { id: "counte", number: 8 },
    { id: "counte1", number: 7 },
    { id: "counte2", number: 13 },
    { id: "counte3", number: 11 },
    { id: "counte4", number: 21 },
    { id: "counte5", number: 16 },
  ];
  ids.forEach((id) => {
    const countUp = new CountUp(id.id, id.number, { duration: 50 });
    countUp.start();
  });
});
</script>
            ...
            <div class="row task">
              <div class="col-xl-2 col-sm-4 col-6">
                <div class="task-summary">
                  <div class="d-flex align-items-center">
                    <h2 class="text-primary" id="counte">0</h2>
              ...
              <div class="col-xl-2 col-sm-4 col-6">
                <div class="task-summary">
                  <div class="d-flex align-items-center">
                    <h2 class="text-purple count" id="counte1">0</h2>
              ...
              <div class="col-xl-2 col-sm-4 col-6">
                <div class="task-summary">
                  <div class="d-flex align-items-center">
                    <h2 class="text-warning count" id="counte2">0</h2>
                    <span>Testing</span>
                  </div>
                  <p>Tasks assigne</p>
                </div>
              ...
              <div class="col-xl-2 col-sm-4 col-6">
                <div class="task-summary">
                  <div class="d-flex align-items-center">
                    <h2 class="text-danger count" id="counte3">0</h2>
                    <span>Awaiting</span>
                  </div>
                  <p>Tasks assigne</p>
                </div>
              ...
              <div class="col-xl-2 col-sm-4 col-6">
                <div class="task-summary">
                  <div class="d-flex align-items-center">
                    <h2 class="text-success count" id="counte4">0</h2>
                    <span>Complete</span>
                  </div>
                  <p>Tasks assigne</p>
                </div>
              ...
              <div class="col-xl-2 col-sm-4 col-6">
                <div class="task-summary">
                  <div class="d-flex align-items-center">
                    <h2 class="text-danger count" id="counte5">0</h2>
                    <span>pending</span>
                  </div>
                  <p>Tasks assigne</p>
                </div>
                ...
                >
                  <div class="filter-option">
                    <div class="filter-option-inner">
                      <div class="filter-option-inner-inner">priority</div>
                    </div>
                  </div>
                </button>
