...
const selectBox = ref([{ title: "Today" }, { title: "Week" }, { title: "Month" }]);

const svgImage = SVGImage;
</script>

<template>
  <PageTitle name="Dashboard" title="Dashboard" />
  <ClientOnly>
                ...
                >
                  <div class="filter-option">
                    <div class="filter-option-inner">
                      <!-- <div class="filter-option-inner-inner">{{ selectOption }}</div> -->
                    </div>
                  </div>
                </button>
                <!-- <div class="dropdown-menu" style="max-height: 202px; overflow: hidden; min-height: 100px">
                      ...
                      >
                        <ul class="dropdown-menu inner show" role="presentation" style="margin-top: 0px; margin-bottom: 0px">
                          <li
                            :class="selectOption === title ? 'active selected' : ''"
                          ...
                          >
                            <a
                              role="option"
                              :class="`dropdown-item ${selectOption === title ? 'active selected' : ''}`"
                              id="bs-select-3-0"
                              tabindex="0"
                              aria-setsize="3"
                              aria-posinset="1"
