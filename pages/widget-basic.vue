  ...
  <ClientOnly>
    <div class="container-fluid">
      <div class="row">
                ...
                <div>
                  <div class="d-inline-block position-relative donut-chart-sale mb-2">
                    ...
                    ><svg class="peity" height="80" width="80">
                      <path d="M 40 0 A 40 40 0 1 1 1.0028835127270526 48.90083735825258 L 7.827378897999822 47.34319082055838 A 33 33 0 1 0 40 7" data-value="5" fill="rgb(59, 215, 225)"></path>
                      <path
          ...
          <div class="card">
            <div class="card-body">
              <div class="students1 d-flex align-items-center justify-content-between flex-wrap">
                ...
                <div>
                  <div class="d-inline-block position-relative donut-chart-sale mb-2">
                    <span class="donut1" data-peity='{ "fill": ["rgb(255, 97, 117)", "rgba(245, 245, 245, 1"],   "innerRadius": 33, "radius": 10}' style="display: none">5/8</span
                    ><svg class="peity" height="80" width="80">
                      <path d="M 40 0 A 40 40 0 1 1 11.715728752538102 68.2842712474619 L 16.665476220843935 63.33452377915607 A 33 33 0 1 0 40 7" data-value="5" fill="rgb(255, 97, 117)"></path>
                      <path
        ...
        <div class="col-xl-4 col-lg-12 col-sm-12">
          <div class="card overflow-hidden">
            <div class="text-center p-3 overlay-box" :style="`background-image: url(${IMAGE.bigImg1})`">
              <div class="profile-photo">
                <img src="../assets/images/profile/profile.png" width="100" class="img-fluid rounded-circle" alt="" />
              </div>
