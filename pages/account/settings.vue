...
<template>
  <PageTitle name="Settings" title="Dashboard" />
  <div class="container-fluid">
    <Profile2 title="Settings" />
                ...
                <div class="row mb-4">
                  ...
                  <div class="col-md-9">
                    <div class="d-inline-block position-relative me-4 mb-3 mb-lg-0">
                      ...
                      <button type="button" class="btn btn-primary btn-sharp position-absolute bottom-0 end-0">
                ...
                <div class="row align-items-center mb-4">
                  ...
                  <div class="col-md-9">
                    <div class="dropdown bootstrap-select default-select form-control">
                      <CustomSelect :options="[{ title: 'Please select' }, { title: 'India' }, { title: 'China' }, { title: 'USA' }]" />
                    </div>
                  </div>
                </div>
                <div class="row align-items-center mb-4">
            ...
            <div class="card-body">
              <div class="alert alert-warning border-warning outline-dashed py-3 px-3 mt-1 mb-4 mb-0 text-dark d-flex align-items-center">
                ...
                <div class="mx-3">
                  ...
                  <p class="mb-0">
                    For extra security, this requires you to confirm your email or phone number when you reset your password. <a href="javascript:void(0);" class="text-warning">Learn More</a>
                  </p>
                </div>
              </div>
              <div class="form-check custom-checkbox me-4 my-3 d-inline-block">
                ...
                <label class="form-check-label mb-0 text-secondary" for="checkboxDeactivation">Confirm Account Deactivation</label>
              </div>
            </div>
            <div class="card-footer text-end">
