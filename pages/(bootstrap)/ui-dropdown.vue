              ...
              <div class="card dz-card scrollAccordian" id="basic-dropdown">
                <div class="card-header border-0 flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#BasicDropdown-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="#dropdown-divider">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab1" data-bs-toggle="tab" data-bs-target="#DropdownDivider-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="dropdown-header">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab3" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab3" data-bs-toggle="tab" data-bs-target="#DropdownHeader-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="disable-active">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab4" data-bs-toggle="tab" data-bs-target="#DisableActive-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="align-right">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab5" data-bs-toggle="tab" data-bs-target="#AlignRight-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="dropup">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab6" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab6" data-bs-toggle="tab" data-bs-target="#Dropup-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="dropright">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab7" data-bs-toggle="tab" data-bs-target="#Dropright-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="dropstart">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab8" data-bs-toggle="tab" data-bs-target="#Dropstart-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                    ...
                    <div class="card-body pt-0">
                      <div class="basic-dropdown">
                        ...
                        <div class="btn-group mb-1">
                          ...
                          <button type="button" class="btn mb-2 btn-primary">Split dropstart</button>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab9" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab9" data-bs-toggle="tab" data-bs-target="#ButtonDropdowns-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="sizing">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab10" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab10" data-bs-toggle="tab" data-bs-target="#Sizing-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="custom-style">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab11" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab11" data-bs-toggle="tab" data-bs-target="#CustomStyle-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="tab-pane fade show active" id="CustomStyle" role="tabpanel" aria-labelledby="home-tab11">
                    <div class="card-body pt-0">
                      <div class="row">
                        ...
                        <div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
                          <div class="dropdown custom-dropdown">
                            <button type="button" class="btn me-2 mb-2 btn-sm btn-primary d-flex align-items-center" data-bs-toggle="dropdown">
                        ...
                        <div class="col-xl-3 col-md-3 col-sm-4 col-6 mb-3 mb-sm-0">
                          <div class="dropdown custom-dropdown">
                            <button type="button" class="btn me-2 mb-2 btn-sm btn-primary flex-wrap" data-bs-toggle="dropdown">
                              <i class="ti-calendar me-3"></i> March 20, 2018 &nbsp; To &nbsp;April 20, 2018
                              <i class="fa fa-angle-down ms-3"></i>
                            </button>
                            <div class="dropdown-menu dropdown-menu-end">
                              <a class="dropdown-item" href="javascript:void(0);">May 20, 2018 &nbsp; To &nbsp; June 20, 2018</a>
                              <a class="dropdown-item" href="javascript:void(0);">July 20, 2018 &nbsp; To &nbsp; August 20, 2018</a>
                            </div>
                          </div>
                        </div>
                        <div class="col-xl-3 col-md-3 col-sm-4 col-6">
                          <div class="dropdown custom-dropdown">
                            <div class="btn me-2 mb-2 sharp btn-primary tp-btn ms-3" data-bs-toggle="dropdown">
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              <li>
                <a @click="scrollView(0)" href="javascript:void(0)" class="scroll">Basic Dropdown</a>
              </li>
              <li>
                <a @click="scrollView(1)" href="javascript:void(0)" class="scroll">Dropdown Divider</a>
              </li>
              <li>
                <a @click="scrollView(2)" href="javascript:void(0)" class="scroll">Dropdown Header</a>
              </li>
              <li>
              ...
              <li>
                <a @click="scrollView(6)" href="javascript:void(0)" class="scroll">Button Dropdowns</a>
              </li>
