              ...
              <div class="card dz-card scrollAccordian" id="accordion-one">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#html" type="button" role="tab" aria-controls="html" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
            ...
            <div class="card dz-card scrollAccordian" id="accordion-two">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-1" data-bs-toggle="tab" data-bs-target="#bordered-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="accordion-three">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-2" data-bs-toggle="tab" data-bs-target="#withoutSpace-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              ...
              <div class="tab-content" id="myTabContent-2">
                ...
                <div class="tab-pane fade" id="withoutSpace-html" role="tabpanel" aria-labelledby="home-tab-2">
                  <div class="card-body pt-0 p-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-no-gutter accordion-header-bg scrollAccordian" id="accordion-three"&gt;
	&lt;div class="accordion-item"&gt;
            ...
            <div class="card dz-card scrollAccordian" id="accordion-four">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-3" data-bs-toggle="tab" data-bs-target="#withoutBorder-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              ...
              <div class="tab-content" id="myTabContent-3">
                ...
                <div class="tab-pane fade" id="withoutBorder-html" role="tabpanel" aria-labelledby="home-tab-3">
                  <div class="card-body pt-0 p-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-no-gutter accordion-bordered scrollAccordian" id="accordion-four"&gt;
    &lt;div class="accordion-item"&gt;
            ...
            <div class="card dz-card scrollAccordian" id="accordion-five">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-4" data-bs-toggle="tab" data-bs-target="#leftPosition-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              <!-- tab-content -->
              <div class="tab-content" id="myTabContent-4">
                ...
                <div class="tab-pane fade" id="leftPosition-html" role="tabpanel" aria-labelledby="home-tab-4">
                  <div class="card-body pt-0 p-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-start-indicator scrollAccordian" id="accordion-five"&gt;
    &lt;div class="accordion-item"&gt;
            ...
            <div class="card dz-card scrollAccordian" id="accordion-six">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-5" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-5" data-bs-toggle="tab" data-bs-target="#widthicon-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              <div class="tab-content" id="myTabContent-5">
                ...
                <div class="tab-pane fade" id="widthicon-html" role="tabpanel" aria-labelledby="home-tab-5">
                  <div class="card-body pt-0 p-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-with-icon scrollAccordian" id="accordion-six"&gt;
&lt;div class="accordion-item"&gt;
            ...
            <div class="card dz-card scrollAccordian" id="accordion-seven">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-6" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-6" data-bs-toggle="tab" data-bs-target="#headerbackground-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              <div class="tab-content" id="myTabContent-6">
                ...
                <div class="tab-pane fade" id="headerbackground-html" role="tabpanel" aria-labelledby="home-tab-6">
                  <div class="card-body pt-0 p-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-header-bg accordion-bordered scrollAccordian" id="accordion-seven"&gt;
&lt;div class="accordion-item"&gt;
            ...
            <div class="card dz-card scrollAccordian" id="accordion-eight">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-7" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-7" data-bs-toggle="tab" data-bs-target="#solidbackground-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              <div class="tab-content" id="myTabContent-7">
                ...
                <div class="tab-pane fade" id="solidbackground-html" role="tabpanel" aria-labelledby="home-tab-7">
                  <div class="card-body pt-0 p-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-solid-bg scrollAccordian" id="accordion-eight"&gt;
    &lt;div class="accordion-item"&gt;
            ...
            <div class="card dz-card scrollAccordian" id="accordion-nine">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-8" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-8" data-bs-toggle="tab" data-bs-target="#activebackground-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="accordion-ten">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-9" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-9" data-bs-toggle="tab" data-bs-target="#headerShadow-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              ...
              <div class="tab-content" id="myTabContent-9">
                ...
                <div class="tab-pane fade" id="headerShadow-html" role="tabpanel" aria-labelledby="home-tab-9">
                  <div class="card-body pt-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-header-shadow accordion-rounded scrollAccordian" id="accordion-ten"&gt;
    &lt;div class="accordion-item"&gt;
            ...
            <div class="card dz-card scrollAccordian" id="accordion-eleven">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-10" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-10" data-bs-toggle="tab" data-bs-target="#roundedStylish-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              <div class="tab-content" id="myTabContent-10">
                ...
                <div class="tab-pane fade" id="roundedStylish-html" role="tabpanel" aria-labelledby="home-tab-10">
                  <div class="card-body pt-0 p-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-rounded-stylish accordion-bordered scrollAccordian" id="accordion-eleven"&gt;
    &lt;div class="accordion-item"&gt;
            ...
            <div class="card dz-card scrollAccordian" id="accordion-twelve">
              <div class="card-header flex-wrap d-flex justify-content-between border-0">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab-11" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab-11" data-bs-toggle="tab" data-bs-target="#gradient-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              <div class="tab-content" id="myTabContent-11">
                ...
                <div class="tab-pane fade" id="gradient-html" role="tabpanel" aria-labelledby="home-tab-11">
                  <div class="card-body pt-0 p-0 code-area">
                    <pre class="mb-0"><code class="language-html">&lt;div class="accordion accordion-rounded-stylish accordion-gradient scrollAccordian" id="accordion-twelve"&gt;
&lt;div class="accordion-item"&gt;
        ...
        <div class="demo-right-inner navigation navbar" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav nav" id="menu-bar">
              <li>
                <a @click="scrollView(0)" href="javaScript:void(0)" class="scroll">Default Accordion</a>
              </li>
              <li>
                <a @click="scrollView(1)" href="javaScript:void(0)" class="scroll">Accordion Bordered</a>
              </li>
              <li>
                <a @click="scrollView(2)" href="javaScript:void(0)" class="scroll">Accordion without space</a>
              </li>
              <li>
                <a @click="scrollView(3)" href="javaScript:void(0)" class="scroll">Accordion without space with border</a>
              </li>
              <li>
                <a @click="scrollView(4)" href="javaScript:void(0)" class="scroll">Accordion indicator in left position</a>
              </li>
              <li>
                <a @click="scrollView(5)" href="javaScript:void(0)" class="scroll">Accordion with icon</a>
              </li>
              <li>
                <a @click="scrollView(6)" href="javaScript:void(0)" class="scroll">Accordion header background</a>
              </li>
              <li>
                <a @click="scrollView(7)" href="javaScript:void(0)" class="scroll">Accordion solid background</a>
              </li>
              <li>
                <a @click="scrollView(8)" href="javaScript:void(0)" class="scroll">Accordion active background</a>
              </li>
              <li>
                <a @click="scrollView(9)" href="javaScript:void(0)" class="scroll">Accordion header shadow</a>
              </li>
              <li>
                <a @click="scrollView(10)" href="javaScript:void(0)" class="scroll">Accordion Rounded Stylish</a>
              </li>
              <li>
                <a @click="scrollView(11)" href="javaScript:void(0)" class="scroll">Accordion Gradient</a>
              </li>
            </ul>
          </div>
        </div>
