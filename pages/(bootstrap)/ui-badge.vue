              ...
              <div class="card dz-card scrollAccordian" id="badges-size">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#BadgesSize-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="badges-light">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-1" data-bs-toggle="tab" data-bs-target="#BadgesLight-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="badges">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-2" data-bs-toggle="tab" data-bs-target="#Badges-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="pill-badge">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-3" data-bs-toggle="tab" data-bs-target="#PillBadge-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="link-badge">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-4" data-bs-toggle="tab" data-bs-target="#LinkBadge-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="rounded-badge">
                <div class="card-header flex-wrap d-flex justify-content-between">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-6" data-bs-toggle="tab" data-bs-target="#RoundedBadge-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-6">
                  <div class="tab-pane fade show active" id="RoundedBadge" role="tabpanel" aria-labelledby="home-tab-6">
                    <div class="card-body">
                      <div class="bootstrap-badge">
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-primary">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-secondary">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-success">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-danger">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-warning">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-info">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-light">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-dark">Rounded</a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian" id="rounded-outline">
                <div class="card-header flex-wrap d-flex justify-content-between">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-7" data-bs-toggle="tab" data-bs-target="#OutlineBadge-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-7">
                  <div class="tab-pane fade show active" id="OutlineBadge" role="tabpanel" aria-labelledby="home-tab-7">
                    <div class="card-body">
                      <div class="bootstrap-badge">
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-outline-primary">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-outline-secondary">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-outline-success">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-outline-danger">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-outline-warning">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-outline-info">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-outline-light">Rounded</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-rounded badge-outline-dark">Rounded</a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian" id="outline-circle">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-8" data-bs-toggle="tab" data-bs-target="#OutlineCircle-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-8">
                  <div class="tab-pane fade show active" id="OutlineCircle" role="tabpanel" aria-labelledby="home-tab-8">
                    <div class="card-body pt-0">
                      <div class="bootstrap-badge">
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-outline-primary">1</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-outline-secondary">2</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-outline-success">3</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-outline-danger">4</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-outline-warning">5</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-outline-info">6</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-outline-light">7</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-outline-dark">8</a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian" id="circle-badge">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-9" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-9" data-bs-toggle="tab" data-bs-target="#CircleBadge-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-9">
                  <div class="tab-pane fade show active" id="CircleBadge" role="tabpanel" aria-labelledby="home-tab-9">
                    <div class="card-body pt-0">
                      <div class="bootstrap-badge">
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-primary">1</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-secondary">2</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-success">3</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-danger">4</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-warning">5</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-info">6</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-light">7</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-circle badge-dark">8</a>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian" id="circle-badge-default">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-10" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-10" data-bs-toggle="tab" data-bs-target="#BadgeDefault-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="tab-pane fade show active" id="BadgeDefault" role="tabpanel" aria-labelledby="home-tab-10">
                    <div class="card-body pt-0">
                      <div class="bootstrap-badge">
                        ...
                        <a href="javascript:void(0)" class="badge me-2 badge-outline-secondary">2</a>
              ...
              <div class="card dz-card scrollAccordian" id="number-badge">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-11" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-11" data-bs-toggle="tab" data-bs-target="#NumberBadge-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="badge-sizes">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-12" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-12" data-bs-toggle="tab" data-bs-target="#BadgeSizes-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-12">
                  <div class="tab-pane fade show active" id="BadgeSizes" role="tabpanel" aria-labelledby="home-tab-12">
                    <div class="card-body pt-0">
                      <div class="bootstrap-badge">
                        <a href="javascript:void(0)" class="badge me-2 badge-xs badge-primary">xs</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-sm badge-secondary">sm</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-md badge-success">md</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-lg badge-danger">lg</a>
                        <a href="javascript:void(0)" class="badge me-2 badge-xl badge-warning">xl</a>
                      </div>
                    </div>
                  </div>
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              ...
              <li class="me-2">
                <a @click="scrollView(6)" href="javascript:void(0)" class="scroll">Rounded Outline Badge </a>
              </li>
              <li class="me-2">
                <a @click="scrollView(7)" href="javascript:void(0)" class="scroll">Outline Circle Badge </a>
              </li>
              <li class="me-2">
                <a @click="scrollView(8)" href="javascript:void(0)" class="scroll">Circle Badge</a>
              </li>
              <li class="me-2">
                <a @click="scrollView(9)" href="javascript:void(0)" class="scroll">Circle Badge Default</a>
              </li>
              <li class="me-2">
