              ...
              <div class="card dz-card scrollAccordian" id="basic-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <!--tab-content-->
              ...
              <div class="card dz-card scrollAccordian" id="color-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-1" data-bs-toggle="tab" data-bs-target="#colorAlerts-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="square-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-2" data-bs-toggle="tab" data-bs-target="#SquareAlerts-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="rounded-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-3" data-bs-toggle="tab" data-bs-target="#RoundedAlerts-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="dismissable-alerts">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-4" data-bs-toggle="tab" data-bs-target="#DismissableAlerts-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="alerts-alt">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-5" data-bs-toggle="tab" data-bs-target="#AlertsAlt-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="solid-alt">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-6" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-6" data-bs-toggle="tab" data-bs-target="#SolidAlt-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="dismissable-solid">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-7" data-bs-toggle="tab" data-bs-target="#Dismissable-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="alert-link">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-8" data-bs-toggle="tab" data-bs-target="#AlertLink-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="alert-link-color">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-9" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-9" data-bs-toggle="tab" data-bs-target="#LinkSolid-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="notifications">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-10" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-10" data-bs-toggle="tab" data-bs-target="#Notifications-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="alert-icon-left">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-11" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-11" data-bs-toggle="tab" data-bs-target="#IconLeft-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="alert-outline">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-12" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-12" data-bs-toggle="tab" data-bs-target="#AlertOutline-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="alert-social">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-13" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-13" data-bs-toggle="tab" data-bs-target="#AlertSocial-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="message-alert">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-14" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-14" data-bs-toggle="tab" data-bs-target="#AlertMessage-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="message-alert-color">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-15" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-15" data-bs-toggle="tab" data-bs-target="#AlertSolidcolor-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="alert-icon-big">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-16" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-16" data-bs-toggle="tab" data-bs-target="#AlertLeftIcon-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              ...
              <li>
                <a @click="scrollView(1)" href="javascript:void(0)" class="scroll">Solid color alerts</a>
              </li>
              <li>
                <a @click="scrollView(2)" href="javascript:void(0)" class="scroll">Square Alerts</a>
              </li>
              <li>
                <a @click="scrollView(3)" href="javascript:void(0)" class="scroll">Rounded Alerts</a>
              </li>
              <li>
                <a @click="scrollView(4)" href="javascript:void(0)" class="scroll">Dismissable Alerts</a>
              </li>
              <li>
              ...
              <li>
                <a @click="scrollView(7)" href="javascript:void(0)" class="scroll">Dismissable with solid</a>
              </li>
              <li>
                <a @click="scrollView(8)" href="javascript:void(0)" class="scroll">Alert with Link</a>
              </li>
              <li>
                <a @click="scrollView(9)" href="javascript:void(0)" class="scroll">Alert with Link and Solid Color</a>
              </li>
              <li>
                <a @click="scrollView(10)" href="javascript:void(0)" class="scroll">Inline Notifications</a>
              </li>
              <li>
                <a @click="scrollView(11)" href="javascript:void(0)" class="scroll">Alert Icon Left</a>
              </li>
              <li>
                <a @click="scrollView(12)" href="javascript:void(0)" class="scroll">Alert outline</a>
              </li>
              <li>
                <a @click="scrollView(13)" href="javascript:void(0)" class="scroll">Alert Social</a>
              </li>
              <li>
                <a @click="scrollView(14)" href="javascript:void(0)" class="scroll">Message Alert</a>
              </li>
              <li>
                <a @click="scrollView(15)" href="javascript:void(0)" class="scroll">Message Alert Color</a>
              </li>
              <li>
                <a @click="scrollView(16)" href="javascript:void(0)" class="scroll">Alert left icon big </a>
              </li>
            </ul>
          </div>
        </div>
