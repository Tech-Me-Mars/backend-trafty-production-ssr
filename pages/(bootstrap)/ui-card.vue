              ...
              <div class="card dz-card scrollAccordian" id="card-title-1">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#CardTitle-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="card-title-2">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-1" data-bs-toggle="tab" data-bs-target="#CardTitle2-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian text-center" id="card-title-3">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-2" data-bs-toggle="tab" data-bs-target="#CardTitle3-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian text-center" id="special-title">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-4" data-bs-toggle="tab" data-bs-target="#TitleTreatment-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-4">
                  <div class="tab-pane fade show active" id="TitleTreatment" role="tabpanel" aria-labelledby="home-tab-4">
                    <div class="card-body pt-0 custom-tab-1">
                      ...
                      <a href="javascript:void(0);" class="btn btn-primary text-white btn-card">Go somewhere</a>
                    </div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian bg-primary text-white" id="primary-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-5" data-bs-toggle="tab" data-bs-target="#Primarycard-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian bg-secondary text-white" id="secondary-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-6" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-6" data-bs-toggle="tab" data-bs-target="#Secondarycard-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian bg-success text-white" id="success-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-7" data-bs-toggle="tab" data-bs-target="#Successcard-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-7">
                  <div class="tab-pane fade show active" id="Successcard" role="tabpanel" aria-labelledby="home-tab-7">
                    <div class="card-body pt-0 mb-0">
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="javascript:void(0);" class="btn bg-white text-success btn-card">Go somewhere</a>
                    </div>
                    <div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago</div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian bg-danger text-white" id="danger-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-8" data-bs-toggle="tab" data-bs-target="#Dangercard-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian bg-warning text-white" id="warning-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-9" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-9" data-bs-toggle="tab" data-bs-target="#Warningcard-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian bg-info text-white" id="info-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-10" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-10" data-bs-toggle="tab" data-bs-target="#Infocard-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian bg-light text-black" id="light-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-11" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-11" data-bs-toggle="tab" data-bs-target="#Lightcard-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-11">
                  <div class="tab-pane fade show active" id="Lightcard" role="tabpanel" aria-labelledby="home-tab-11">
                    <div class="card-body pt-0 mb-0">
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="javascript:void(0);" class="btn bg-white text=black btn-card">Go somewhere</a>
                    </div>
              ...
              <div class="card dz-card scrollAccordian bg-dark text-white" id="dark-card">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs style-2" id="myTab-12" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-12" data-bs-toggle="tab" data-bs-target="#Darkcard-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-12">
                  <div class="tab-pane fade show active" id="Darkcard" role="tabpanel" aria-labelledby="home-tab-12">
                    <div class="card-body pt-0 mb-0">
                      <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                      <a href="javascript:void(0);" class="btn bg-white text-dark btn-card">Go somewhere</a>
                    </div>
                    <div class="card-footer bg-transparent border-0 text-white">Last updateed 3 min ago</div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian overflow-hidden" id="card-title-4">
                ...
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-13" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-13" data-bs-toggle="tab" data-bs-target="#CardTitle4-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian overflow-hidden" id="card-title-5">
                ...
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-14" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-14" data-bs-toggle="tab" data-bs-target="#CardTitle5-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="card-title-6">
                <div class="card-header flex-wrap">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-15" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-15" data-bs-toggle="tab" data-bs-target="#CardTitle6-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
