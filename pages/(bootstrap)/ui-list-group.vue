            ...
            <div class="card dz-card scrollAccordian" id="basic-list">
              <div class="card-header d-flex justify-content-between">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#BasicList-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="list-active">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab1" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab1" data-bs-toggle="tab" data-bs-target="#ListActive-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="list-disabled">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab8" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab8" data-bs-toggle="tab" data-bs-target="#ListDisabled-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="link-button">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab2" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab2" data-bs-toggle="tab" data-bs-target="#LinksButtons-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="flush">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab3" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab3" data-bs-toggle="tab" data-bs-target="#Flush-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="with-badges">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab4" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab4" data-bs-toggle="tab" data-bs-target="#WithBadges-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="custom-content">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab5" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab5" data-bs-toggle="tab" data-bs-target="#CustomContent-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
            ...
            <div class="card dz-card scrollAccordian" id="contextual">
              <div class="card-header flex-wrap d-flex justify-content-between le">
                ...
                <ul class="nav nav-tabs dzm-tabs" id="myTab6" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button class="nav-link" id="profile-tab6" data-bs-toggle="tab" data-bs-target="#Contextual-html" type="button" role="tab" aria-selected="false">Vue</button>
                  </li>
                </ul>
              </div>
              ...
              <div class="card dz-card scrollAccordian" id="list-tab">
                <div class="card-header flex-wrap d-flex justify-content-between le">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab7" data-bs-toggle="tab" data-bs-target="#ListTab-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                          ...
                          <div class="col-lg-6 col-xl-10 col-xxl-9">
                            <div class="tab-content" id="nav-tabContent">
                              <div class="tab-pane fade show active" id="list-home">
                                ...
                                <p>
                                  Velit aute mollit ipsum ad dolor consectetur nulla officia culpa adipisicing exercitation fugiat tempor. Voluptate deserunt sit sunt nisi aliqua fugiat proident ea
                                  ut. Mollit voluptate reprehenderit occaecat nisi ad non minim tempor sunt voluptate consectetur exercitation id ut nulla. Ea et fugiat aliquip nostrud sunt incididunt
                                  consectetur culpa aliquip eiusmod dolor. Anim ad Lorem aliqua in cupidatat nisi enim eu nostrud do aliquip veniam minim.
                                </p>
                              </div>
                              <div class="tab-pane fade" id="list-profile" role="tabpanel">
                                <h4 class="mb-4">Profile Tab Content</h4>
                                <p>
                                  Cupidatat quis ad sint excepteur laborum in esse qui. Et excepteur consectetur ex nisi eu do cillum ad laborum. Mollit et eu officia dolore sunt Lorem culpa qui
                                  commodo velit ex amet id ex. Officia anim incididunt laboris deserunt anim aute dolor incididunt veniam aute dolore do exercitation. Dolor nisi culpa ex ad irure in
                                  elit eu dolore. Ad laboris ipsum reprehenderit irure non commodo enim culpa commodo veniam incididunt veniam ad.
                                </p>
                              </div>
                              <div class="tab-pane fade" id="list-messages">
                                <h4 class="mb-4">Message Tab Content</h4>
                                <p>
                                  Ut ut do pariatur aliquip aliqua aliquip exercitation do nostrud commodo reprehenderit aute ipsum voluptate. Irure Lorem et laboris nostrud amet cupidatat cupidatat
                                  anim do ut velit mollit consequat enim tempor. Consectetur est minim nostrud nostrud consectetur irure labore voluptate irure. Ipsum id Lorem sit sint voluptate est
                                  pariatur eu ad cupidatat et deserunt culpa sit eiusmod deserunt. Consectetur et fugiat anim do eiusmod aliquip nulla laborum elit adipisicing pariatur cillum.
                                </p>
                              </div>
                              <div class="tab-pane fade" id="list-settings">
                                ...
                                <p>
                                  ...
                                  Nisi eu minim cillum occaecat aute est cupidatat aliqua labore aute occaecat ea aliquip sunt amet. Aute mollit dolor ut exercitation irure commodo non amet
                                  consectetur quis amet culpa. Quis ullamco nisi amet qui aute irure eu. Magna labore dolor quis ex labore id nostrud deserunt dolor eiusmod eu pariatur culpa mollit in
                                  irure.
                                </p>
                              </div>
                            </div>
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              <li>
                <a @click="scrollView(0)" href="javascript:void(0)" class="scroll">Basic List Group</a>
              </li>
              <li>
                <a @click="scrollView(1)" href="javascript:void(0)" class="scroll">List Active items</a>
              </li>
              <li>
                <a @click="scrollView(2)" href="javascript:void(0)" class="scroll">List Disabled Item</a>
              </li>
              <li>
                <a @click="scrollView(3)" href="javascript:void(0)" class="scroll">Link And Button Item</a>
              </li>
              ...
              <li>
                <a @click="scrollView(6)" href="javascript:void(0)" class="scroll">Custom Content</a>
              </li>
              <li>
