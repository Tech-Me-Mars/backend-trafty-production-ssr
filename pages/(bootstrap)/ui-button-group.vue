              ...
              <div class="card dz-card scrollAccordian" id="button-group">
                <div class="card-header d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#ButtonGroup-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="button-toolbar">
                <div class="card-header d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-1" data-bs-toggle="tab" data-bs-target="#ButtonToolbar-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="button-sizing">
                <div class="card-header d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-2" data-bs-toggle="tab" data-bs-target="#ButtonSizing-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="button-nesting">
                <div class="card-header d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-3" data-bs-toggle="tab" data-bs-target="#ButtonNesting-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="vertical-variation">
                <div class="card-header d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-4" data-bs-toggle="tab" data-bs-target="#VerticalVariation-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="vertical-dropdown">
                <div class="card-header d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-5" data-bs-toggle="tab" data-bs-target="#VerticalDropdown-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              ...
              <li>
                <a @click="scrollView(1)" href="javascript:void(0)" class="scroll">Button Toolbar</a>
              </li>
              <li>
                <a @click="scrollView(2)" href="javascript:void(0)" class="scroll">Button Sizing</a>
              </li>
              <li>
                <a @click="scrollView(3)" href="javascript:void(0)" class="scroll">Button Nesting</a>
              </li>
              <li>
                <a @click="scrollView(4)" href="javascript:void(0)" class="scroll">Vertical Variation</a>
              </li>
              <li>
                <a @click="scrollView(5)" href="javascript:void(0)" class="scroll">Vertical Dropdown Variation</a>
              </li>
            </ul>
          </div>
        </div>
