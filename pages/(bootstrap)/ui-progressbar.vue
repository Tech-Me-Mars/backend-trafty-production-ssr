              ...
              <div class="card dz-card" id="default-progress">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#DefaultProgressr-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="striped-progress">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab1" data-bs-toggle="tab" data-bs-target="#StripedProgress-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="colored-progress">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab3" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab3" data-bs-toggle="tab" data-bs-target="#ColoredProgress-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="different-bar">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab4" data-bs-toggle="tab" data-bs-target="#Differentbar-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="animated-striped">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab5" data-bs-toggle="tab" data-bs-target="#AnimatedStriped-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="vertical-progress">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab6" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab6" data-bs-toggle="tab" data-bs-target="#VerticalProgress-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="vertical-progress-bottom">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab7" data-bs-toggle="tab" data-bs-target="#Progressbottom-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="different-size">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab8" data-bs-toggle="tab" data-bs-target="#DifferentSize-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="animated-bars">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab9" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab9" data-bs-toggle="tab" data-bs-target="#AnimatedBars-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card" id="skill-bars">
                <div class="card-header flex-wrap border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab10" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab10" data-bs-toggle="tab" data-bs-target="#SkillBars-html" type="button" role="tab">Vue</button>
                    </li>
                  </ul>
                </div>
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              ...
              <li>
                <a href="#vertical-progress-bottom" class="scroll">Vertical Progress From bottom </a>
              </li>
