              ...
              <div class="card dz-card scrollAccordian" id="default-button">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#Buttons-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="buttons-with-icon">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-1" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-1" data-bs-toggle="tab" data-bs-target="#Buttons-Icon-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-1">
                  <div class="tab-pane fade show active" id="Buttons-Icon" role="tabpanel" aria-labelledby="home-tab-1">
                    <div class="card-body pt-0">
                      <button type="button" class="btn me-2 mb-2 btn-primary"><i class="fa-brands mt-2 fa-accusoft me-2 mb-2"></i>Primary</button>
                      <button type="button" class="btn me-2 mb-2 btn-secondary"><i class="fa-solid mt-2 fa-table-cells-large me-2 mb-2"></i>Secondary</button>
                      <button type="button" class="btn me-2 mb-2 btn-success"><i class="fa-solid mt-2 fa-gear me-2 mb-2"></i>Success</button>
                      <button type="button" class="btn me-2 mb-2 btn-danger"><i class="fa-solid mt-2 fa-circle-exclamation me-2 mb-2"></i>Danger</button>
                      <button type="button" class="btn me-2 mb-2 btn-warning"><i class="fa-solid mt-2 fa-image me-2 mb-2"></i>Warning</button>
                      <button type="button" class="btn me-2 mb-2 btn-info"><i class="fa-solid mt-2 fa-phone-volume me-2 mb-2"></i>Info</button>
                      <button type="button" class="btn me-2 mb-2 btn-light"><i class="fa-solid mt-2 fa-lock me-2 mb-2"></i>Light</button>
                      <button type="button" class="btn me-2 mb-2 btn-dark"><i class="fa-solid mt-2 fa-circle-play me-2 mb-2"></i>Dark</button>
                    </div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian" id="button-light">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-2" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-2" data-bs-toggle="tab" data-bs-target="#LightStyle-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="default-outline-button">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-3" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-3" data-bs-toggle="tab" data-bs-target="#OutlineButtons-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="button-sizes">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-4" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-4" data-bs-toggle="tab" data-bs-target="#ButtonSizes-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="button-sizes-icon">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-5" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-5" data-bs-toggle="tab" data-bs-target="#ButtonSizesIcon-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="outline-button-sizes">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-6" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-6" data-bs-toggle="tab" data-bs-target="#outlineButtonSizes-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
                <div class="tab-content" id="myTabContent-6">
                  <div class="tab-pane fade show active" id="outlineButtonSizes" role="tabpanel" aria-labelledby="home-tab-6">
                    <div class="card-body pt-0">
                      ...
                      <button type="button" class="btn me-2 mb-2 btn-outline-primary btn-xs">Small button</button>
                      <button type="button" class="btn me-2 mb-2 btn-outline-primary btn-sm">Extra small button</button>
                    </div>
                  </div>
              ...
              <div class="card dz-card scrollAccordian" id="rounded-buttons">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-7" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-7" data-bs-toggle="tab" data-bs-target="#RoundedButtons-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="rounded-outline-buttons">
                <div class="card-header flex-wrap d-flex border-0 justify-content-between">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-8" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-8" data-bs-toggle="tab" data-bs-target="#RoundedOutline-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="button-right-icons">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-9" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-9" data-bs-toggle="tab" data-bs-target="#ButtonRightIcons-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="button-left-icons">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-10" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-10" data-bs-toggle="tab" data-bs-target="#ButtonLeftIcons-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="square-buttons">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-11" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-11" data-bs-toggle="tab" data-bs-target="#SquareButtons-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="square-outline-buttons">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-12" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-12" data-bs-toggle="tab" data-bs-target="#SquareOutline-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="rounded-button">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-13" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-13" data-bs-toggle="tab" data-bs-target="#RoundedButton2-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="rounded-outline-buttons-1">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-14" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-14" data-bs-toggle="tab" data-bs-target="#RoundedOutlineButton2-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="dropdown-button">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-15" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-15" data-bs-toggle="tab" data-bs-target="#DropdownButton-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="buttons-transparent">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-16" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-16" data-bs-toggle="tab" data-bs-target="#ButtonsTransparent-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="buttons-transparent-light">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-17" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-17" data-bs-toggle="tab" data-bs-target="#TransparentLight-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="disabled-button">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-18" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-18" data-bs-toggle="tab" data-bs-target="#DisabledButton-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
              ...
              <div class="card dz-card scrollAccordian" id="socia-icon-buttons">
                <div class="card-header flex-wrap d-flex justify-content-between border-0">
                  ...
                  <ul class="nav nav-tabs dzm-tabs" id="myTab-19" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="profile-tab-19" data-bs-toggle="tab" data-bs-target="#ButtonsName-html" type="button" role="tab" aria-selected="false">Vue</button>
                    </li>
                  </ul>
                </div>
        ...
        <div class="demo-right-inner dz-scroll" id="right-sidebar">
          ...
          <div class="dz-scroll demo-right-tabs" id="rightSidebarScroll">
            <ul class="navbar-nav" id="menu-bar">
              <li>
                <a href="javascript:void(0)" @click="scrollView(0)" class="scroll">Default Button</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(1)" class="scroll">Buttons With Icon</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(2)" class="scroll">Button Light</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(3)" class="scroll">Default Outline Button</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(4)" class="scroll">Button Sizes</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(5)" class="scroll">Button Sizes icon</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(6)" class="scroll">Outline Button Sizes</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(7)" class="scroll">Rounded Buttons</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(8)" class="scroll">Rounded Outline Buttons</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(9)" class="scroll">Button Right Icons</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(10)" class="scroll">Button Left Icons</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(11)" class="scroll">Square Buttons</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(12)" class="scroll">Square Outline Buttons</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(13)" class="scroll">Rounded Button</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(14)" class="scroll">Rounded Outline Buttons</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(15)" class="scroll">Buttons Transparent Light</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(16)" class="scroll">Buttons Transparent</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(17)" class="scroll">Disabled Button</a>
              </li>
              <li>
                <a href="javascript:void(0)" @click="scrollView(18)" class="scroll">Socia icon Buttons with Name</a>
              </li>
            </ul>
          </div>
        </div>
