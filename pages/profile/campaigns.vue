...
<template>
  <PageTitle name="Campaigns" title="Dashboard" />
  <div class="container-fluid">
    <Profile title="Campaigns" />
          ...
          <div class="card overflow-hidden">
            <div class="card-body p-4">
              <div class="p-2">
                ...
                <p class="mb-0">
                  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M14.1667 5.8335L5.83337 14.1668" stroke="var(--bs-danger)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                    <path d="M14.1667 14.1668H5.83337V5.8335" stroke="var(--bs-danger)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  </svg>
