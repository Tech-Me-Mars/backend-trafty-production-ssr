  ...
  <div class="col-xl-3 col-lg-5">
    ...
    <div class="recent-post">
      <div class="blog-img style-1">
        <img src="../../assets/images/blog/professional.jpg" alt="" class="blk-img" />
        <div class="blog-text">
          ...
          <img src="../../assets/images/contacts/pic1.jpg" class="avatar rounded-circle me-2" alt="" />
      ...
      <div class="third-post style-1">
        ...
        <div class="post-1">
          <div class="post-data">
            <h4>Debugging is like being</h4>
            <div class="mb-2">
              <img src="../../assets/images/contacts/pic2.jpg" class="avatar rounded-circle me-2 small-post" alt="" />
              <span> April 05, 2023</span>
            </div>
          </div>
        </div>
    ...
    <div class="mb-4">
      <ul class="c-social">
        <li>
          <a href="javascript:void(0);" class="bg-facebook"><i class="fa-brands fa-facebook-f"></i></a>
        </li>
        <li>
          <a href="javascript:void(0);" class="bg-whatsapp"><i class="fa-brands fa-whatsapp"></i></a>
        </li>
        <li>
          <a href="javascript:void(0);" class="bg-linkedin"><i class="fa-brands fa-linkedin-in"></i></a>
        </li>
        <li>
          <a href="javascript:void(0);" class="bg-skype"><i class="fa-brands fa-skype"></i></a>
        </li>
      </ul>
    </div>
      ...
      <div class="card-body">
        ...
        <div class="notify-data">
          ...
          <form>
            ...
            <span class="text-start mt-3 d-block text-danger">* We promise that we don't spam ! </span>
          </form>
        </div>
      </div>
    </div>
    ...
    <div class="recent-post">
      ...
      <div class="third-post style-2">
        <img src="../../assets/images/contacts/pic1.jpg" class="avatar rounded-circle me-2 av-post" alt="" />
        <div class="post-1">
          <div class="post-data">
      ...
      <div class="third-post style-2">
        <img src="../../assets/images/contacts/pic2.jpg" class="avatar rounded-circle me-2 av-post" alt="" />
        <div class="post-1">
          <div class="post-data">
      ...
      <div class="third-post style-2">
        <img src="../../assets/images/contacts/pic3.jpg" class="avatar rounded-circle me-2 av-post" alt="" />
        <div class="post-1">
          <div class="post-data">
