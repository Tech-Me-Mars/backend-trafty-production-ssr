...
function upadteChart(value) {
  switch (value) {
    case "day":
      state.series[0].data = [700, 650, 680, 650, 700, 610, 710, 620];
      break;
    case "week":
      state.series[0].data = [700, 700, 680, 600, 700, 620, 710, 620];
      break;
    case "month":
      state.series[0].data = [700, 650, 690, 640, 700, 670, 710, 620];
      break;
    case "year":
      state.series[0].data = [700, 650, 590, 650, 700, 610, 710, 630];
      break;
    default:
      break;
  }
    ...
    <div class="card">
      ...
      <div class="card-body px-0 overflow-hidden">
        <div class="total-earning">
          ...
          <client-only>
            <div id="earningChart" ref="chartEle">
              <VueApexCharts type="area" height="350px" :options="state.chartOption" :series="state.series" />
            </div>
          </client-only>
        </div>
      </div>
