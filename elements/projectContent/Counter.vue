...
onMounted(() => {
  const ids = [
    { id: "counte0", number: 24 },
    { id: "counte1", number: 12 },
    { id: "counte2", number: 7 },
    { id: "counte3", number: 5 },
  ];
  ids.forEach((id) => {
...
<template>
  <div class="col-xl-3 col-sm-6" v-for="({ img, color }, ind) in counterData" :key="ind">
    <div class="card box-hover">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="icon-box icon-box-lg bg-success-light rounded-circle" v-html="img"></div>
          <div class="total-projects ms-3">
            <h3 :class="`text-${color} count`" :id="`counte${ind}`">0</h3>
