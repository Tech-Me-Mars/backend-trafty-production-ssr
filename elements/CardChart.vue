        ...
        <div class="card chart-grd same-card">
          <div class="card-body depostit-card p-0">
            ...
            <div id="apaxlinechart">
              <apexchart height="40" :options="lineChart.chartOptions" :series="lineChart.series"></apexchart>
            </div>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-sm-6">
        <div class="card same-card">
          <div class="card-body d-flex align-items-center py-2">
            <div id="AllProject">
              <apexchart type="donut" height="125" width="150px" :options="pieChart.chartOptions" :series="pieChart.series"></apexchart>
            </div>
        ...
        <div class="card chart-grd same-card">
          <div class="card-body depostit-card p-0">
            ...
            <div id="NewExperience">
              <apexchart height="40" :options="lineChart2.chartOptions" :series="lineChart2.series"></apexchart>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card overflow-hidden">
          ...
          <div class="card-body p-0">
            <div id="overiewChart" ref="updateData">
              <apexchart type="line" height="300px" :options="state.chartOptions" :series="state.series"></apexchart>
            </div>
...
import { lineChart, pieChart, lineChart2 } from "@/lib/ChartsData";
